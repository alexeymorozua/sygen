...
Cross-tool skill sync between sygen workspace and CLI skill homes.
...
`cleanup_sygen_links(paths)` removes managed links under CLI skill dirs whose targets point to managed roots.
