...
if sys.platform == "win32":
    from sygen_bot.infra import service_windows as _backend
elif sys.platform == "darwin":
    from sygen_bot.infra import service_macos as _backend
else:
    from sygen_bot.infra import service_linux as _backend
