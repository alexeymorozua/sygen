"""Entry point: python -m sygen_bot."""
...
# tests that patch sygen_bot.__main__.<name>.
from sygen_bot.cli_commands.agents import cmd_agents as _cmd_agents
from sygen_bot.cli_commands.api_cmd import cmd_api as _cmd_api
from sygen_bot.cli_commands.docker import cmd_docker as _cmd_docker
from sygen_bot.cli_commands.install import cmd_install as _cmd_install
from sygen_bot.cli_commands.lifecycle import (
...
from sygen_bot.cli_commands.service import cmd_service as _cmd_service
from sygen_bot.cli_commands.status import (
...
def _cmd_setup(verbose: bool) -> None:
    ...
    from sygen_bot.cli.init_wizard import run_onboarding, run_smart_reset
...
def _default_action(verbose: bool) -> None:
    ...
    if not _is_configured():
        from sygen_bot.cli.init_wizard import run_onboarding
