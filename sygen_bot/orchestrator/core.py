...
from sygen_bot.background import (
    BackgroundSubmit,
    BackgroundTask,
)
from sygen_bot.cli.process_registry import ProcessRegistry
from sygen_bot.cli.service import CLIService, CLIServiceConfig
from sygen_bot.config import AgentConfig
from sygen_bot.cron.manager import CronManager
...
from sygen_bot.infra.inflight import InflightTracker
...
from sygen_bot.session import SessionKey, SessionManager
...
class Orchestrator:
    ...
    async def create(
        ...
        *,
        ...
        """
        from sygen_bot.orchestrator.lifecycle import create_orchestrator
    ...
    def register_multiagent_commands(self) -> None:
        ...
        """
        from sygen_bot.multiagent.commands import (
            cmd_agent_restart,
            cmd_agent_start,
            cmd_agent_stop,
            cmd_agents,
    ...
    def submit_named_session(
        ...
        from sygen_bot.cli.param_resolver import resolve_cli_config
    ...
    async def _ensure_docker(self) -> None:
        ...
        from sygen_bot.orchestrator.lifecycle import ensure_docker
    ...
    def _on_config_hot_reload(self, config: AgentConfig, hot: dict[str, object]) -> None:
        ...
        if "language" in hot:
            from sygen_bot.i18n import init as init_i18n
    ...
    async def shutdown(self) -> None:
        ...
        from sygen_bot.orchestrator.lifecycle import shutdown
