...
from sygen_bot.background import BackgroundObserver, BackgroundResult
...
from sygen_bot.config import AgentConfig, get_gemini_models
from sygen_bot.config_reload import ConfigReloader
from sygen_bot.cron.manager import CronManager
from sygen_bot.cron.observer import CronObserver
from sygen_bot.heartbeat import HeartbeatObserver
...
class ObserverManager:
    ...
    def wire_to_bus(
        ...
        *,
        ...
        """
        from sygen_bot.bus.adapters import (
