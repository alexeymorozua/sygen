...
from sygen_bot.cli.auth import AuthStatus, check_claude_auth, check_codex_auth, check_gemini_auth
from sygen_bot.config import DEFAULT_EMPTY_GEMINI_API_KEY, AgentConfig, deep_merge_config
...
def _build_extras_table(console: Console) -> None:
    ...
    from sygen_bot.infra.docker_extras import DOCKER_EXTRAS_BY_ID, extras_for_display
...
def _ask_docker_extras(console: Console) -> list[str]:
    ...
    from sygen_bot.infra.docker_extras import (
        DOCKER_EXTRAS_BY_ID,
        extras_for_display,
        resolve_extras,
    )
...
def run_onboarding() -> bool:
    ...
    if run_as_service:
        from sygen_bot.infra.service import install_service
