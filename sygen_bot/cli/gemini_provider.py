...
from sygen_bot.cli.auth import gemini_api_key_mode_selected
from sygen_bot.cli.base import (
    BaseCLI,
    CLIConfig,
    _feed_stdin_and_close,
    docker_wrap,
)
from sygen_bot.cli.gemini_events import extract_result_text, extract_text, parse_gemini_stream_line
from sygen_bot.cli.gemini_utils import (
    create_system_prompt_file,
    find_gemini_cli,
    find_gemini_cli_js,
)
from sygen_bot.cli.stream_events import ResultEvent, StreamEvent, SystemInitEvent
from sygen_bot.cli.types import CLIResponse
from sygen_bot.config import NULLISH_TEXT_VALUES
from sygen_bot.infra.platform import CREATION_FLAGS as _CREATION_FLAGS
from sygen_bot.infra.process_tree import force_kill_process_tree
from sygen_bot.workspace.paths import resolve_paths

if TYPE_CHECKING:
    from sygen_bot.cli.process_registry import ProcessRegistry, TrackedProcess
