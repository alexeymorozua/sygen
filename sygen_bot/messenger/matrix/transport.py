...
from sygen_bot.bus.cron_sanitize import sanitize_cron_result_text
from sygen_bot.bus.envelope import Envelope, Origin
from sygen_bot.messenger.matrix.sender import MatrixSendOpts
...
class MatrixTransport:
    ...
    async def _broadcast(self, text: str) -> None:
        ...
        from sygen_bot.messenger.matrix.bot import resolve_broadcast_rooms
