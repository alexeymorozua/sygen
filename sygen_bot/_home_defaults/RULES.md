...
This is the top-level `~/.sygen` directory.
...
- `~/.sygen/agents.json` is the single source of truth for all sub-agent
...
`~/.sygen/SHAREDMEMORY.md` contains facts shared across all agents
