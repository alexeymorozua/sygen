...
from sygen_bot.infra.service_macos import (
    _LABEL,
...
class TestIsServiceRunning:
    ...
    @patch("sygen_bot.infra.service_macos._run_launchctl")
    @patch("sygen_bot.infra.service_macos.is_service_installed", return_value=True)
...
class TestStopService:
    @patch("sygen_bot.infra.service_macos._run_launchctl")
    @patch("sygen_bot.infra.service_macos.is_service_running", return_value=True)
    ...
    @patch("sygen_bot.infra.service_macos.is_service_running", return_value=False)
