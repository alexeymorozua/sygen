...
from sygen_bot.infra.service_windows import (
    _TASK_NAME,
    _generate_task_xml,
    _is_access_denied,
    install_service,
...
class TestGenerateTaskXml:
    def test_contains_command(self) -> None:
        xml = _generate_task_xml(r"C:\Python\pythonw.exe", "-m sygen_bot")
...
class TestIsServiceRunning:
    ...
    @patch("sygen_bot.infra.service_windows._run_schtasks")
    @patch("sygen_bot.infra.service_windows.is_service_installed", return_value=True)
...
class TestInstallService:
    ...
    @patch(
        "sygen_bot.infra.service_windows._find_pythonw",
    ...
    @patch("sygen_bot.infra.service_windows.is_service_available", return_value=False)
...
class TestStopService:
    @patch("sygen_bot.infra.service_windows._run_schtasks")
    @patch("sygen_bot.infra.service_windows.is_service_running", return_value=True)
    ...
    @patch("sygen_bot.infra.service_windows.is_service_running", return_value=False)
...
class TestPrintServiceLogs:
    ...
    @patch("sygen_bot.infra.service_windows.resolve_paths")
    @patch("sygen_bot.infra.service_windows.is_service_installed", return_value=True)
