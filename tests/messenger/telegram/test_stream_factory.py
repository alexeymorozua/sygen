...
from sygen_bot.config import StreamingConfig
...
class TestCreateStreamEditor:
    ...
    def test_append_mode_returns_stream_editor(self) -> None:
        from sygen_bot.messenger.telegram.streaming import StreamEditor, create_stream_editor
    ...
    def test_edit_mode_returns_edit_stream_editor(self) -> None:
        from sygen_bot.messenger.telegram.edit_streaming import EditStreamEditor
