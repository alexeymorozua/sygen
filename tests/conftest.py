...
def _no_real_process_signals() -> object:
    ...
    with (
        patch(
            "sygen_bot.cli.process_registry.terminate_process_tree",
            return_value=None,
        ),
        patch(
            "sygen_bot.cli.process_registry.force_kill_process_tree",
            return_value=None,
        ),
        patch(
            "sygen_bot.cli.process_registry.interrupt_process",
            return_value=None,
        ),
        patch(
            "sygen_bot.cli.executor.force_kill_process_tree",
            return_value=None,
        ),
        patch(
            "sygen_bot.cli.gemini_provider.force_kill_process_tree",
            return_value=None,
        ),
        patch(
            "sygen_bot.cron.execution.force_kill_process_tree",
            return_value=None,
        ),
        patch(
            "sygen_bot.infra.pidlock.terminate_process_tree",
            return_value=None,
        ),
        patch(
            "sygen_bot.infra.pidlock.force_kill_process_tree",
            return_value=None,
        ),
        patch(
            "sygen_bot.infra.pidlock.list_process_descendants",
            return_value=[],
        ),
    ):
        yield
